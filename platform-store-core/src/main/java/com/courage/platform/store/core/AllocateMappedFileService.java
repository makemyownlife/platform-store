...
import com.courage.platform.store.core.util.ServiceThread;
...
public class AllocateMappedFileService extends ServiceThread {
    ...
    public MappedFile putRequestAndReturnMappedFile(String nextFilePath, String nextNextFilePath, int fileSize) {
        ...
        if (this.messageStore.getMessageStoreConfig().isTransientStorePoolEnable()) {
            if (this.messageStore.getMessageStoreConfig().isFastFailIfNoBufferInStorePool()) { //if broker is slave, don't fast fail even no buffer in pool
    ...
    private boolean mmapOperation() {
        ...
        try {
            ...
            if (req.getMappedFile() == null) {
                ...
                long elapsedTime = PlatformUtilAll.computeElapsedTimeMilliseconds(beginTime);
                if (elapsedTime > 10) {

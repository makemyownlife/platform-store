...
import com.courage.platform.store.core.config.FlushDiskType;
    ...
    public boolean destroy(final long intervalForcibly) {
        ...
        if (this.isCleanupOver()) {
            try {
                ...
                log.info("delete file[REF:" + this.getRefCount() + "] " + this.fileName + (result ? " OK, " : " Failed, ") + "W:" + this.getWrotePosition() + " M:" + this.getFlushedPosition() + ", " + PlatformUtilAll.computeElapsedTimeMilliseconds(beginTime));
            } catch (Exception e) {

...
public class StoreCheckpoint {
    ...
    public StoreCheckpoint(final String scpPath) throws IOException {
        ...
        if (fileExists) {
            ...
            log.info("store checkpoint file physicMsgTimestamp " + this.physicMsgTimestamp + ", " + PlatformUtilAll.timeMillisToHumanString(this.physicMsgTimestamp));
            log.info("store checkpoint file logicsMsgTimestamp " + this.logicsMsgTimestamp + ", " + PlatformUtilAll.timeMillisToHumanString(this.logicsMsgTimestamp));
            log.info("store checkpoint file indexMsgTimestamp " + this.indexMsgTimestamp + ", " + PlatformUtilAll.timeMillisToHumanString(this.indexMsgTimestamp));
        } else {
